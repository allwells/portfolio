...
const Card = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Card", defaultProps, props), { component, className, p, radius, children, classNames, styles: styles$1 } = _a, others = __objRest(_a, ["component", "className", "p", "radius", "children", "classNames", "styles"]);
  const { classes, cx } = Card_styles['default'](null, { name: "Card", classNames, styles: styles$1 });
